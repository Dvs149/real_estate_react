        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link to="/properties" className="hover:text-amber-400 transition-colors">All Properties</Link></li>
              <li><Link to="/properties?purpose=buy" className="hover:text-amber-400 transition-colors">Properties for Sale</Link></li>
              <li><Link to="/properties?purpose=rent" className="hover:text-amber-400 transition-colors">Properties for Rent</Link></li>
              <li><Link to="/agents" className="hover:text-amber-400 transition-colors">Featured Agents</Link></li>
              <li><Link to="/blog" className="hover:text-amber-400 transition-colors">Market Insights</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link to="/properties?city=ahmedabad" className="hover:text-amber-400 transition-colors">Ahmedabad Luxury Homes</Link></li>
              <li><Link to="/properties?city=mumbai" className="hover:text-amber-400 transition-colors">Mumbai Sea-View Flats</Link></li>
              <li><Link to="/properties?city=goa" className="hover:text-amber-400 transition-colors">Goa Beach Villas</Link></li>
              <li><Link to="/properties?city=bangalore" className="hover:text-amber-400 transition-colors">Bangalore Eco Villas</Link></li>
              <li><Link to="/properties?city=gurgaon" className="hover:text-amber-400 transition-colors">Gurgaon Penthouses</Link></li>
            </ul>
          </div>
