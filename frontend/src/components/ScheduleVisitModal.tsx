        ...
        {success ? (
          <div className="text-center py-8 space-y-4">
            ...
            <p className="text-sm text-slate-400 max-w-xs mx-auto">
              Your appointment for <span className="text-amber-400 font-semibold">{property.title}</span> on {formatDate(date)} at {timeSlot} is confirmed.
            </p>
            <button
              onClick={onClose}
              className="px-6 py-2.5 rounded-xl bg-amber-400 text-slate-950 font-bold text-sm hover:bg-amber-300 cursor-pointer"
            >
              Done
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-400 text-slate-950 font-bold text-sm hover:from-amber-400 hover:to-amber-300 shadow-lg shadow-amber-500/20 cursor-pointer"
            >
